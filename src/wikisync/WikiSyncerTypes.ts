...
export interface GetPlayerRequest
  extends WikiSyncerRequest<WikiSyncerRequestType.GET_PLAYER> {
  data: Record<string, never>
}

export type WikiSyncerRequestsUnion = GetPlayerRequest
...
export interface GetPlayerResponse
  extends WikiSyncerResponse<WikiSyncerRequestType.GET_PLAYER> {
...
export type CalcResponse<T extends WikiSyncerRequestType> =
  WikiSyncerResponsesUnion & { type: T }
