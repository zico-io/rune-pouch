...
export const TOA_OBELISK_IDS = [11750, 11751, 11752]
...
export const VERZIK_IDS = [
  ...
  10833,
  10834,
  10835, // verzik entry mode
  8372,
  8373,
  8374, // verzik normal mode
  10850,
  10851,
  10852, // verzik hard mode
]
...
export const TOB_MONSTER_IDS = [
  ...
  10770,
  10771,
  10772, // xarpus (i think there's an extra one here because of its different p3 behaviour?)
  10850,
  10851,
  10852, // verzik
  10854,
...
const DUSK_IDS = [
  ...
  7882,
  7883,
  7886, // dusk first form
  7887,
  7888,
  7889, // dusk second form
]
 ...
 */
export const IMMUNE_TO_MAGIC_DAMAGE_NPC_IDS = [...DUSK_IDS]
...
export const AUTOCAST_STANCES: CombatStyleStance[] = [
  'Autocast',
  'Defensive Autocast',
]
export const CAST_STANCES: CombatStyleStance[] = [
  ...AUTOCAST_STANCES,
  'Manual Cast',
]
